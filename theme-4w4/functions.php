...
function theme_4w4_scripts() {
	...
	wp_enqueue_style( 'wpb-google-fonts', 'https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300;1,600&display=swap', false ); 
	...
	wp_register_script('theme-4w4-api-rest', get_template_directory_uri(). '/js/api-rest.js', array(), filemtime(get_template_directory(). "/js/api-rest.js"), true);
